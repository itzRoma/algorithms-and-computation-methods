...
public class Gui extends JFrame {
    ...
    private void build() {
        ...
        final NonEditableTextField rootsTextField = new NonEditableTextField(10);
        final NonEditableTextField rangesTextField = new NonEditableTextField(10);
