package com.itzroma.acm.labs.lab3.gui;

import com.itzroma.acm.labs.lab3.gui.components.CustomLabel;
import com.itzroma.acm.labs.lab3.gui.components.NotEditableTextField;
...
public class Gui extends JFrame {
    ...
    private void build() {
        ...
        final NotEditableTextField yField = new NotEditableTextField(10);
        final NotEditableTextField errorField = new NotEditableTextField(10);
        final NotEditableTextField errorOfErrorField = new NotEditableTextField(10);
        final NotEditableTextField errorBlurField = new NotEditableTextField(10);
